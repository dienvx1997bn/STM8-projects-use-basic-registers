...
//project base on :https://blog.mark-stevens.co.uk/2012/08/using-the-uart-on-the-stm8s-2/
//check RM0016, 22.3.4 High precision baud rate generator
//
...
void InitialiseUART()
{
    ...
    UART1_BRR2 = 0x01;      //  Set the baud rate registers to 115200 baud
    UART1_BRR1 = 0x01;      //  based upon a 2 MHz system clock.
    //
